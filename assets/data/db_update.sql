...
ALTER TABLE  `product` ADD  `stock_status` ENUM(  'in-stock',  'factory' ) NOT NULL AFTER  `status` ,
ADD  `ship_restrict` VARCHAR( 255 ) NOT NULL AFTER  `stock_status`;
